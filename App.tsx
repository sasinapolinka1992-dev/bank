...
const App: React.FC = () => {
  ...
  const filteredBanks = useMemo(() => {
    return banks.filter(bank => {
      ...
      return matchesSearch && matchesStatus && matchesPrograms;
    });
  }, [banks, searchQuery, statusFilter, programFilter]);
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-900">
      ...
      {/* Top Navigation (Mock) */}
      <header className="bg-white border-b border-gray-200 h-16 flex items-center px-8 shadow-sm z-10 sticky top-0">
         <div className="text-xl font-bold text-primary mr-8">АдминПанель</div>
         <nav className="flex gap-6 text-sm font-medium text-gray-600">
            <a href="#" className="hover:text-primary">Дашборд</a>
            <a href="#" className="text-primary">Настройки банков</a>
            <a href="#" className="hover:text-primary">Объекты</a>
            <a href="#" className="hover:text-primary">CRM</a>
         </nav>
      ...
      <main className="flex-1 p-8 max-w-[1600px] mx-auto w-full">
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm mb-6 flex flex-col lg:flex-row gap-4 justify-between items-center">
          ...
          <div className="relative w-full lg:w-96">
            ...
            <input 
              type="text"
              placeholder="Поиск банка по названию..."
              value={searchQuery}
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
             ...
             <select 
               ...
               className="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:border-primary outline-none"
             >
