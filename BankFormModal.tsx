              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all ${errors.name ? 'border-danger' : 'border-gray-300'}`}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="col-span-1 md:col-span-2">
                                    ...
                                    <select
                                        ...
                                        className={`w-full px-3 py-2 border rounded-md text-sm bg-white ${errors[`program_${index}_name`] ? 'border-danger' : 'border-gray-200'}`}
                                    >
                                ...
                                <div className={program.autoRates ? "opacity-60 pointer-events-none" : ""}>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-3 py-2 border rounded-md text-sm ${errors[`program_${index}_rate`] ? 'border-danger' : 'border-gray-200'}`}
